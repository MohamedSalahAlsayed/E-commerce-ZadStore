      ...
      >
        ...
        >
          <v-text-field
            ...
            :label="$t('coupons.search_placeholder')"
            variant="outlined"
            density="compact"
            hide-details
        ...
        <v-table class="coupons-table pa-2">
          ...
          <tbody>
            <template v-if="loading">
              <tr v-for="i in 5" :key="`skel-coupon-${i}`">
                <td class="px-2 py-3">
                  <v-skeleton-loader type="chip" style="min-width: 120px" />
                </td>
                <td class="px-2">
                  <v-skeleton-loader
                    type="text"
                ...
                <td class="px-2">
                  <div
                    class="d-flex flex-column gap-1 mx-auto"
            ...
            <tr v-else-if="!loading && !filteredCoupons.length">
              ...
              <td class="text-center text-grey-darken-1 font-weight-medium">
                {{
                  coupon.type === "percentage" || coupon.type === "percent"
                    ? $t("coupons.types.percent")
                    : $t("coupons.types.fixed")
                }}
              </td>
    ...
    <v-dialog v-model="dialog" max-width="500px" persistent>
      <v-card class="rounded-xl pa-2">
        <v-card-title
          ...
          style="color: rgb(var(--v-theme-primary))"
        >
          {{ isEditing ? $t("coupons.edit_coupon") : $t("coupons.new_coupon") }}
        </v-card-title>
            ...
            <v-row>
              <v-col cols="12">
                <v-text-field
                  ...
                  :label="$t('coupons.form.code_label')"
                  variant="outlined"
                  color="primary"
                  class="text-uppercase"
                  :rules="[(v) => !!v || $t('coupons.form.code_required')]"
                >
                  <template v-slot:append-inner>
                    <v-btn
                      ...
                      :title="$t('coupons.form.generate_code')"
                    ></v-btn>
                  </template>
                </v-text-field>
              </v-col>
              ...
              <v-col cols="12" sm="6">
                <v-select
                  ...
                  :items="[
                    { title: $t('coupons.types.percent'), value: 'percent' },
                    { title: $t('coupons.types.fixed'), value: 'fixed' },
                  ]"
                ...
                <v-text-field
                  ...
                  :label="
                    ...
                    editedItem.type === 'percent'
                      ? $t('coupons.form.value_percent')
                      : $t('coupons.form.value_fixed')
                  "
                  type="number"
                  variant="outlined"
                  color="primary"
