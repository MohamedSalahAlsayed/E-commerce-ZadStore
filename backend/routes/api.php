...
Route::middleware(['auth:sanctum', AdminMiddleware::class])->prefix('admin')->group(function () {
    ...
    Route::get('/financials', [\App\Http\Controllers\AdminFinancialController::class, 'getFinancials'])->middleware('permission:view_financials');
    ...
    // Orders & CRM
    Route::group(['middleware' => 'permission:manage_orders'], function () {
    ...
    // Returns
    Route::group(['middleware' => 'permission:manage_returns'], function () {
    ...
    // Marketing & Content
    Route::group(['middleware' => 'permission:manage_marketing'], function () {
    ...
    // Analytics
    Route::group(['middleware' => 'permission:view_financials'], function () {
        Route::get('/analytics/overview', [\App\Http\Controllers\AnalyticsController::class, 'getOverview']);
        Route::get('/analytics/products', [\App\Http\Controllers\AnalyticsController::class, 'getProductAnalytics']);
    });
});
