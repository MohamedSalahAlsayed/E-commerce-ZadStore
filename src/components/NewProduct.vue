    ...
    <v-container>
      ...
      <v-row>
        ...
        <v-col cols="12" md="8" v-else>
          <v-slide-group show-arrows class="py-4 custom-slide-group">
            <v-slide-group-item
              v-for="product in flashDeals.products.slice(0, 8)"
              :key="product.id"
            >
              <div class="px-3">
                <v-card
        ...
        <v-col cols="12" md="4" class="d-none d-md-flex align-center">
          <div class="promo-banner-wrapper w-100">
            <v-hover v-slot="{ isHovering, props }">
              <v-img
                v-bind="props"
                src="../assets/banner.png"
                class="rounded-xl promo-img"
                height="450"
                cover
                :elevation="isHovering ? 12 : 2"
              >
                <div class="promo-overlay d-flex flex-column justify-end pa-8">
                  <h3 class="text-h3 font-weight-black text-white mb-2">
                    تسوق الآن
                  </h3>
                  <p class="text-h6 text-white opacity-80 mb-6">
                    اكتشف أحدث التشكيلات العصرية
                  </p>
                  <v-btn
                    color="white"
                    variant="flat"
                    size="large"
                    class="rounded-lg font-weight-black w-fit"
                  >
                    اكتشف المزيد
                  </v-btn>
                </div>
